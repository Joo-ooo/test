pipeline {
    ...
    environment {
        ...
        DEPENDENCY_CHECK_HOME = '/var/jenkins_home/org.jenkinsci.plugins.DependencyCheck.tools.DependencyCheckInstallation/OWASP_Dependency-Check/dependency-check'
    }
    ...
    stages {
        ...
        stage('Clone Repository') {
            steps {
                dir('workspace') {
                    git branch: 'main', url: 'https://github.com/Joo-ooo/test.git'
                }
            }
        }
